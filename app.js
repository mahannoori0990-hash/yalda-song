...
const translations = {
  ...
  en: {
    ...
    faqEyebrow:'Good to know', faqTitle:'Frequently asked questions', faqIntro:'Quick answers to the most important questions about the event and song submissions.', faqStudentsQ:'Is the event only for students?', faqStudentsA:'No. The event is open to everyone.', faqAgeQ:'Is there an age restriction?', faqAgeA:'Yes. Admission is limited to guests aged 18 and over.', faqSongsQ:'What are the song submission limits?', faqSongsA:'Songs can be submitted without registration and there is no time limit between submissions.', faqWhereQ:'Where and when is the event?', faqWhereA:'Friday, 18 December 2026 from 22:00 at KulturCafé, Universitätsstraße 150, 44801 Bochum Süd.'
  },
  de: {
